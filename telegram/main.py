...
def kuma_push():
    # ⚠️ Yahan Cloudflare Worker wala naya URL daalein (.workers.dev wala)
    push_url = "https://deliver.connectbadsha.workers.dev"
    
    headers = {
        "User-Agent": "Heroku-Bot"
    }
    
    while True:
        try:
            # Ab Heroku bot seedha Worker ko ping karega
